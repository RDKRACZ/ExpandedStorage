...
public final class Common {
    ...
    static void registerOldChestContent(RegistrationConsumer<OldChestBlock, BlockItem, AbstractChestBlockEntity> registrationConsumer) {
        ...
        oldChestBlockEntityType = BlockEntityType.Builder.create((pos, state) -> new AbstractChestBlockEntity(Common.getOldChestBlockEntityType(), pos, state, ((AbstractStorageBlock) state.getBlock()).getBlockId(), false), blocks).build(null);
