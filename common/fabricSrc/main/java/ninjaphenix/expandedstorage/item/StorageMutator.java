...
public class StorageMutator extends Item {
    ...
    protected ActionResult useOnBlock(ItemUsageContext context, BlockState state, BlockPos pos) {
        ...
        //                        this.convertBlock(world, state, pos, Common.getTieredBlock(Common.CHEST_BLOCK_TYPE, Utils.WOOD_TIER_ID), Utils.WOOD_STACK_COUNT, type, isRandomizable);
        //                        this.convertBlock(world, otherState, otherPos, Common.getTieredBlock(Common.CHEST_BLOCK_TYPE, Utils.WOOD_TIER_ID), Utils.WOOD_STACK_COUNT, type.getOpposite(), isRandomizable);
        //                        tag.remove("pos");
        //                        //noinspection ConstantConditions
