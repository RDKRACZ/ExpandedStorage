...
public final class BarrelMain {
    ...
    public static void initialize() {
        BarrelCommon.registerContent(BarrelMain::registerBlocks, BarrelMain::registerItems, BarrelMain::registerBET, TagFactory.BLOCK.create(new Identifier("c", "wooden_barrels")));
    }
}
